...
| [JOB-46](cards/JOB-46-cv-nao-preenche-o-modal-de-filtros.md) | **O currículo não preenche mais os filtros** — a caixa diz "we ticked 13 filters" e nenhum aparece | P | medido (26/08) — a barra de dropdowns virou modal em trabalho não commitado; o `aoLerCv` continua certo, falta o modal ler o rascunho |
